...
// this is used for generating unique ids for backend and will be passed in backend
export const generateBackendId = () => {
  const id = new Types.ObjectId();
  return id.toString();
};

// this is used for generating unique ids for UI components and wont be stored in backend
export const generateUIId = () => _uniqueId();
